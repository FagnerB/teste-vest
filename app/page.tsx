    ...
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl space-y-6 animate-fade-in-up">
            <h1 className="text-5xl md:text-7xl font-bold text-foreground leading-tight text-balance">
              ...
              Seu treino.
              <br />
              <span className="text-bg--600">Seu lifestyle.</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed text-pretty">
                A Vestuario & Cia nasceu da paixão por Moda e bem-estar. Acreditamos que roupas de qualidade fazem
      ...
      <section className="py-16 md:py-24 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center space-y-6">
          ...
          <Button size="lg" variant="secondary" className="bg-gray-300 text-bg-blackhover:bg-white/90" asChild>
            <a
